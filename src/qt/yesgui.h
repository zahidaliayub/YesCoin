...
/**
  Yes GUI main class. This class represents the main window of the Yes UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class YesGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit YesGUI(QWidget *parent = 0);
    ~YesGUI();
