...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::YES).toInt();
    ...
    fAutoRedeemYes = settings.value("fAutoRedeemYes", false).toBool();
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemYes: return "AutoRedeemYes";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::YES).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemYes: {
            fAutoRedeemYes = value.toBool();
            settings.setValue("fAutoRedeemYes", fAutoRedeemYes);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemYes() { return fAutoRedeemYes; }
