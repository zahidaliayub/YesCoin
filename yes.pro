...
build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.yescoin
    BOOST_LIB_SUFFIX=-mt
...
contains(YES_NEED_QT_PLUGINS, 1) {
    DEFINES += YES_NEED_QT_PLUGINS
...
# also add new translations to yes.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/yesclient*.ts)
...
macx:ICON = src/qt/res/icons/yes.icns
macx:TARGET = "YesClient"
